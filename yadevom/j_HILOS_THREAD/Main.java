package com.yadevom.j_HILOS_THREAD;

import java.time.LocalDateTime;

/**
 * La concurrencia es la capacidad de ejecutar varios programas o varias partes de un programa en paralelo. Si una tarea que requiere mucho tiempo se puede realizar de forma asíncrona o en paralelo, esto mejora el rendimiento y la interactividad del programa.
 *
 * Para ello en JAVA tenemos HILOS o THREADS, en este videotutorial podremos ver como crearlos y usarlos en JAVA.
 */
