 ...
 * Ejemplo hizo una aplicacion que recibe notificacion por email, y luego estan las notificaciones
 * de redes sociales, en vez de cambiar todo el codigo, con el decorador se agregan esta nueva funcionalidad
 **/
