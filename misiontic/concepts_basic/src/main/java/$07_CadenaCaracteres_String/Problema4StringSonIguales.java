...
/**
 * Desarrollar un algoritmo que retorne un valor booleano que indique si dos cadenas son iguales,
 * esto es, que tienen la misma longitud con los mismos símbolos en la mismas posiciones.
 * **/

public class Problema4StringSonIguales {
