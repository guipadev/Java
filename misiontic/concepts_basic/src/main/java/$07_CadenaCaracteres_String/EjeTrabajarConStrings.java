...
Primero se indica el tipo de objeto que se va a instanciar, en este caso sería String
Luego se define un nombre para el objeto que se está creando String myString
...
public class EjeTrabajarConStrings {
    ...
    public static void main (String[] args){
        ...
        **/
        ...
        System.out.println(s.substring(10, s.length())); // es genial!
