...
public class Avion
{
    ...
    public Avion() {
        ...
        // Inicializar los valores uno a uno
        ...
        // Terminamo de Inicializar los valores por medio de un ciclo
        // EL 1ero número de sillas ejecutivas va a ser 9
    ...
    public Silla buscarSillaEjecutivaLibre( int ubicacion ) {
        ...
        if( encontrado )
            ...
            return null;
        */
    	// Otra forma más corta con recorrido parcial
    	Silla silla = null;
