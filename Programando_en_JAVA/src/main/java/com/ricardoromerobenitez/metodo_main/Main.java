package com.ricardoromerobenitez.metodo_main;
//https://programandoenjava.com/metodo-main-en-java/

/**
 * El metodo main en java es el punto de partida de nuestro programa, sin el ningun programa
 * funcionaria es un metodo estatico por lo cual debe estar dentro de un clase
 *
 ...
 * Tipo de parametro un array "String[] arg" que acepta tipos de argumentos para ejecutar el
 * programa
 */
