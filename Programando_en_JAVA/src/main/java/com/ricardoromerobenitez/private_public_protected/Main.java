package com.ricardoromerobenitez.private_public_protected;

/**
 * La encapsulación es uno de los cuatro conceptos fundamentales de OOP. Los otros tres son
 * herencia, polimorfismo y abstracción.
 *
 * La encapsulación en Java es un mecanismo para envolver los datos (variables) y el código
 * que actúa sobre los datos (métodos) juntos como una sola unidad.
 * En la encapsulación, las variables de una clase se ocultarán de otras clases y solo se
 * puede acceder a ellas a través de los métodos de su clase actual.
 * Por lo tanto, también se conoce como ocultación de datos.
 */
